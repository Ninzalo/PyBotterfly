...
async def first_page(user_messenger_id: int, user_messenger: str) -> Returns:
...
async def second_page(user_messenger_id: int, user_messenger: str) -> Returns:
    await change_user_stage(
...
async def third_page(user_messenger_id: int, user_messenger: str) -> Returns:
    await change_user_stage(
...
async def error_page(user_messenger_id: int, user_messenger: str) -> Returns:
